...
export class PageGanttComponent implements ng.IComponentOptions {
    public template: string = require('./pageGantt.html');

    // public bindings: any = {
    //     data: "@"
    // };
    public controller: any = GanttController;
}
...
export class GanttController {
    ...
    constructor(
        ...
        GanttObjectModel: any,
        ganttMouseOffset: any,
        ganttDebounce: any
       ...
       let addEventName = function(eventName, func) {
            ...
            api: function(api) {
                ...
                api.core.on.ready($scope, function() {
                    ...
                    api.data.on.change($scope, function(newData) {
                        if (this.dataToRemove === undefined) {
                            this.dataToRemove = [
        ...
        $scope.load = () => {
            ...
            this.dataToRemove = undefined;

            $scope.timespans = this.sampleTimeSpans;
        };
        ...
        $scope.remove = function() {
            $scope.api.data.remove(this.dataToRemove);
